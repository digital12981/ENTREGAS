      ...
      try {
        ...
        if (success && statusData) {
          ...
          if (statusData.status === 'APPROVED') {
            ...
            const amount = statusData.amount ? parseFloat(statusData.amount) / 100 : 39.90;
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700">
                        ...
                        Kit Oficial de Entregador da Shopee. O kit é entregue a preço de custo por <strong>R$39,90</strong>.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-row gap-2 items-start">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-md font-bold text-[#E83D22]">R$ 39,90</p>
