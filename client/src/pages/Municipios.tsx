    ...
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <Dialog open={showStartDateModal} onOpenChange={setShowStartDateModal}>
        <DialogContent className="sm:max-w-md p-6 bg-white">
          <DialogTitle className="text-xl font-bold text-[#E83D22] text-center">Atenção! Oportunidade de Trabalho</DialogTitle>
          <DialogDescription className="text-base text-center text-gray-700 py-2">
            Na região que você escolheu, estamos com <span className="font-bold">URGENTE</span> necessidade
            de novos entregadores, pois a demanda de entregas está alta e temos poucos entregadores cadastrados.
          </DialogDescription>
          
          <div className="mt-4 mb-4">
            <h3 className="font-medium text-gray-800 mb-3 text-center">Quando você pode começar?</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
              {getNextThreeDays().map((date, index) => (
                <Button
                  ...
                  className={`py-3 px-2 h-auto ${selectedStartDate === date.value ? 'bg-[#E83D22] hover:bg-[#d73920] border-[#E83D22]' : 'border-gray-300 hover:border-[#E83D22] hover:text-[#E83D22]'}`}
                >
                  {date.full}
                </Button>
              ))}
            ...
            <Button
              ...
              className={`w-full mt-3 py-3 h-auto ${selectedStartDate === 'outro' ? 'bg-[#E83D22] hover:bg-[#d73920] border-[#E83D22]' : 'border-gray-300 hover:border-[#E83D22] hover:text-[#E83D22]'}`}
            >
              Outro dia
            </Button>
          </div>
          ...
          <DialogFooter>
            <Button 
              ...
              className="w-full bg-[#E83D22] hover:bg-[#d73920] text-white" 
