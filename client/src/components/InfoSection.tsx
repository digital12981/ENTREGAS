...
const InfoSection: React.FC = () => {
  return (
    <section className="container mx-auto px-4 py-8 text-[#555]">
      <h2 className="text-xl font-semibold mb-4 border-b-2 border-gray-200 pb-2">Como funciona o Programa Motoristas Parceiros da Uber?</h2>
      <p className="mb-6 leading-relaxed">O Programa de Motoristas Parceiros da Uber é uma oportunidade para quem deseja ganhar uma renda extra realizando coletas, transferências ou entregas de pacotes. Com horários flexíveis e autonomia para organizar sua agenda, você escolhe quando e onde quer trabalhar.</p>
      <p className="mb-6 leading-relaxed">A Uber aceita diferentes tipos de veículos, como <span className="font-bold text-black">motos, carros de passeio (2 ou 4 portas), Fiorino, Kombi e vans</span>. Isso permite que mais pessoas possam participar e transformar seu veículo em uma fonte de renda.</p>

      <h3 className="text-lg font-semibold mt-8 mb-4 border-b-2 border-gray-200 pb-2">Ganhos como Motorista Parceiro Uber</h3>
      <p className="mb-6 leading-relaxed">Na Uber, os pagamentos são realizados de forma instantânea. Assim que o motorista finaliza a rota, o valor correspondente é imediatamente transferido para sua conta. Isso garante maior segurança e agilidade para nossos parceiros, permitindo que eles tenham acesso rápido aos seus ganhos e possam planejar melhor suas finanças.</p>
