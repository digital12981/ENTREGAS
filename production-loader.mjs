/**
 * Carregador de produção para o Heroku (versão ESM)
 * 
...
// Importações de módulos Node.js (versão ESM)
import fs from 'fs';
...
// Criar uma função require para usar em contexto ESM quando necessário
